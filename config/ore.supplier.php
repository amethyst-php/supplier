...
return [
    ...
    */
    ...
    |
    */
    'entity' => Railken\LaraOre\Supplier\Supplier::class,
    ...
    |
    */
    'manager' => Railken\LaraOre\Supplier\SupplierManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\Supplier\SupplierRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\Supplier\SupplierSerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\Supplier\SupplierValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\Supplier\SupplierAuthorizer::class,
    ...
    */
    'http' => [
        'admin' => [
            'enabled'    => true,
            'controller' => Railken\LaraOre\Http\Controllers\Admin\SuppliersController::class,
            'router'     => [
                'prefix' => '/suppliers',
            ],
        ],
